...
public class CachingFacts
{
    ...
    public void ReusesAnalysisAcrossUnrelatedEdits()
    {
        ...
        var edited = compilation.AddSyntaxTrees(
            CSharpSyntaxTree.ParseText("namespace Other { public class Unrelated {} }", parseOptions, cancellationToken: TestContext.Current.CancellationToken));
        driver = driver.RunGenerators(edited, cancellationToken: TestContext.Current.CancellationToken);
